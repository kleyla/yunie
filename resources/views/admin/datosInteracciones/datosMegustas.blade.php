            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">Datos me gustas</h4>
                            ...
                            <table class="table" id="">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $megusta->created_at }}</td>
                                        <td class="td-actions text-right">
                                            <a href="{{route('verProducto', $megusta->id )}}">
                                                <button type="button" rel="tooltip" class="btn btn-info" title="Ver">
                                                    <i class="material-icons">search</i>
                                                </button>
                                            </a>
                                            <a href="{{route('editProducto', $megusta->id )}}">
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="POST" action="{{ route('datosMegustaAdd')}}" id="registrationform"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="cant_monedas" name="cant_monedas"
                            aria-describedby="emailHelp" placeholder="cantidad de monedas">
                    </div>
                </div>
